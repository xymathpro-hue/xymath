    ...
    <div className="container mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      {avaliacoes.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center border border-gray-200">
          ...
          <a href={`/base/diagnosticos/${turmaId}`} className="inline-block px-6 py-3 bg-gray-700 hover:bg-gray-800 text-white rounded-lg font-medium no-underline">
            ...
            <div key={avaliacao.id} className="bg-white rounded-lg shadow p-6 border border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <a href={`/base/avaliacoes/lancar/${turmaId}/${avaliacao.id}`} className="px-4 py-2 bg-gray-700 hover:bg-gray-800 text-white rounded-lg font-medium no-underline">
                    Lançar Notas
                  </a>
                  <a href={`/base/avaliacoes/resultados/${turmaId}/${avaliacao.id}`} className="px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 rounded-lg font-medium no-underline">
                    Ver Resultados
                  </a>
                </div>
              </div>
      ...
      <div className="mt-6 flex gap-4">
        <a href={`/base/diagnosticos/${turmaId}`} className="px-6 py-3 bg-gray-700 hover:bg-gray-800 text-white rounded-lg font-medium no-underline">
          Voltar para Diagnósticos
        </a>
        <a href={`/base/dashboard/${turmaId}`} className="px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 rounded-lg font-medium no-underline">
          Ver Dashboard
        </a>
      </div>
    </div>
